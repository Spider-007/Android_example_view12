...
public class EmptyLayout extends RelativeLayout {
    ...
    private int mErrorDrawable = R.mipmap.img_page_none;
    private int mEmptyDrawable = R.mipmap.img_empty_nodata;
    private int mNoWifiDrawable = R.mipmap.img_no_wifi;
    private int notData = R.mipmap.img_no_add;
