...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setStrokeWidth(DeviceUtils.dip2px(getContext(), 2));
        mOutlinePaint.setColor(getResources().getColor(R.color.black_translucent));
        mOutlinePaint.setStyle(Style.STROKE);

        int padding = DeviceUtils.dip2px(getContext(), 10);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int offset = DeviceUtils.dip2px(getContext(), 5);
