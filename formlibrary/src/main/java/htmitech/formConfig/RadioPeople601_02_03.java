...
//            lineView.setBackgroundResource(R.drawable.corners_bg_white_press_stroke_v);
        ...
        return setReView601_02_03(item);


    }

    public LinearLayout setReView601_02_03(final FieldItem item){
...
//        edit.setSign(item.getSign());
        ...
        tvEditValue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                ((TextView) v).setText("");
                ComponentInit.getInstance().getmICallCheckUserListener().getCheckUserListener(currentEditTextView,ICallCheckUserListener.IChooseWay.PEOPLECHOOSE,ICallCheckUserListener.Choose.SINGLE_CHOOSE);
