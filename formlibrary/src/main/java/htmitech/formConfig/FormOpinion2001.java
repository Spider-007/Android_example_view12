...
public class FormOpinion2001 {
    ...
    public void setMustInputLoacal() {
        if (tvOption != null && TextUtils.isEmpty(tvOption.getText().toString())) {
            tvOption.setBackgroundResource(R.drawable.form_input_bg_must_local);
        }
    ...
    public LinearLayout Opinion2001(String VlineVisible, FieldItem item, LayoutInflater mInflater, List<TextView> list_tvsize, YiJianOnclickLisener mCellOnclickLisener, int com_workflow_mobileconfig_IM_enabled) {
        {
...
//            lineView.setBackgroundResource(R.drawable.corners_bg_white_press_stroke_v);
            ...
            return setReView2001(item);
        }
    }

    public LinearLayout setReView2001(final FieldItem item) {
...
//                tvOption.setBackgroundColor(context.getResources().getColor(R.color.form_bg_must));
            tvOption.setBackgroundResource(R.drawable.form_edittext_stroke);
        }else{
            tvOption.setBackgroundResource(R.drawable.form_edittext_stroke_nomustinput);
        }

        tvOption.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                ...
                String strValue = tvOption.getText().toString();
...
//                tvOption.setBackgroundColor(context.getResources().getColor(R.color.form_bg_must));
        ...
        String name = ComponentInit.getInstance()                                    //单击布局拿到当前用户
                .getOAUserName();
