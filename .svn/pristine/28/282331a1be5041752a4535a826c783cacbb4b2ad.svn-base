...
/**
 * Created by htrf-pc on 2018/2/27.
 */
...
//        this.setBackgroundColor(Color.BLACK);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TwoWayRattingBar);
        isTwoProgress = a.getBoolean(R.styleable.TwoWayRattingBar_pro_one_two_way,false);

        Resources resources = getResources();
        notScrollBarBg = new ColorDrawable(resources.getColor(R.color.ht_hred_title));
        hasScrollBarBg = new ColorDrawable(resources.getColor(R.color.ht_hred_title));
        mThumbLow =  resources.getDrawable(R.drawable.btn_background_round);
        if(isTwoProgress){
            mThumbHigh =  resources.getDrawable(R.drawable.btn_background_round);
        ...
        mScollBarHeight = (int)resources.getDimension(R.dimen.fab_margi_h);
    ...
    public boolean isTwoProgress() {
        return isTwoProgress;
    }

    public void setTwoProgress(boolean twoProgress) {
        isTwoProgress = twoProgress;
    }
...
//        int height = measureHeight(heightMeasureSpec);
        ...
        mOffsetLow = formatDouble(defaultScreenLow / numberAll * (mDistance)) + mThumbWidth / 2;
        mOffsetHigh = formatDouble(defaultScreenHigh / numberAll * (mDistance)) + mThumbWidth / 2;
...
//        text_Paint.setTextSize(20);
        ...
        double progressLow = formatDouble((mOffsetLow - mThumbWidth / 2) * numberAll / mDistance);
        double progressHigh = formatDouble((mOffsetHigh - mThumbWidth / 2) * numberAll / mDistance);
...
//            }
    ...
    public int getAreaFlag(MotionEvent e) {
        ...
        if (e.getY() >= top && e.getY() <= bottom && e.getX() >= (mOffsetLow - mThumbWidth / 2) && e.getX() <= mOffsetLow + mThumbWidth / 2) {
            ...
            return isTwoProgress ? CLICK_IN_HIGH_AREA : CLICK_IN_LOW_AREA;
    ...
    public void setProgressLow(double progressLow) {
        ...
        mOffsetLow = formatDouble(progressLow / numberAll * (mDistance)) + mThumbWidth / 2;
        isEdit = true;
        refresh();
    }
    ...
    public void setProgressHigh(double progressHigh) {
        ...
        mOffsetHigh = formatDouble(progressHigh / numberAll * (mDistance)) + mThumbWidth / 2;
        isEdit = true;
        refresh();
    }
