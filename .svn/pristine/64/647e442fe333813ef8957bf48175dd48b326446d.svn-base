    ...
    * */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            mViewHolder.llScheduleRoot =  (LinearLayout) convertView.findViewById(R.id.ll_schedule_root);
            mViewHolder.content =  (LinearLayout)convertView.findViewById(R.id.content);
            mViewHolder.delete =  (TextView)convertView.findViewById(R.id.delete);
            mViewHolder.tvTime =  (TextView)convertView.findViewById(R.id.tv_time);
            mViewHolder.tvScheduleTitle =  (TextView)convertView.findViewById(R.id.tv_schedule_title);
            mViewHolder.tvFlag =  (TextView)convertView.findViewById(R.id.tv_flag);
