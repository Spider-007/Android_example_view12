package com.htmitech.emportal.ui.widget.flatingactionButton;
...
/*  @IntDef({ SIZE_NORMAL, SIZE_MINI })*/
  ...
  void init(Context context, AttributeSet attributeSet) {
    ...
    mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal, getColor(android.R.color.darker_gray));
    mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed, getColor(android.R.color.darker_gray));
    mColorDisabled = attr.getColor(R.styleable.FloatingActionButton_fab_colorDisabled, getColor(android.R.color.darker_gray));
    mSize = attr.getInt(R.styleable.FloatingActionButton_fab_size, SIZE_MINI);
