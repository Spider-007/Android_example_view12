...
import com.htmitech.ztcustom.zt.with.OverScrollWarpLayout;


public class UserMessageScrollView extends ScrollView {
    ...
    public UserMessageScrollView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initScrollView();
    }

    public UserMessageScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UserMessageScrollView(Context context) {
        this(context, null);
    }
