...
import com.htmitech.commonx.pulltorefresh.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		mShowIndicator = a.getBoolean(R.styleable.mx_PullToRefresh_mx_ptrShowIndicator, !isPullToRefreshOverScrollEnabled());
	}
