...
import com.htmitech.commonx.base.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.htmitech.commonx.base.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.htmitech.commonx.base.db.table.Id>();

    /* package */
    static synchronized com.htmitech.commonx.base.db.table.Id getId(Class<?> entityType) {
        ...
        com.htmitech.commonx.base.db.table.Id id = new com.htmitech.commonx.base.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.htmitech.commonx.base.db.table.Id id = getId(entityType);
