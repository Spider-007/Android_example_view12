...
package com.htmitech.commonx.base.http.client;

import com.htmitech.commonx.base.http.RequestParams;
import com.htmitech.commonx.base.http.callback.RequestCallBackHandler;
import com.htmitech.commonx.base.http.client.entity.UploadEntity;
import com.htmitech.commonx.base.http.client.util.URIBuilder;
...
public class HttpRequest extends HttpRequestBase implements HttpEntityEnclosingRequest {
    ...
    public URI getURI() {
        try {
            if (uriCharset == null) {
                uriCharset = NetworkUtil.getCharsetFromHttpRequest(this);
            }
            if (uriCharset == null) {
