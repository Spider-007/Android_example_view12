...
public class FunctionPopupWindow extends PopupWindow {
    ...
    public FunctionPopupWindow(Context context, OnClickListener itemsOnClick,
        ...
        mMenuView = inflater.inflate(R.layout.zt_layout_function, null);
...
//            if (!actionList.get(i).getActionID().equalsIgnoreCase("reject")) { // 退回加在最后一个
            ...
            if (actionList != null && actionList.get(i) != null) {
                if (actionList.get(i).getActionID().equalsIgnoreCase("submit") && TodoFlag.equals("0")) // 提交
                    ...
                    item.setIcon(R.mipmap.btn_action_takeback);
                    // item.setColorNormalResId(R.color.color_44b2b2b2);
                else if (actionList.get(i).getActionID().equalsIgnoreCase("Share")) // 分享
                    item.setIcon(R.mipmap.btn_action_share);
                else if (actionList.get(i).getActionID().equalsIgnoreCase("save") && TodoFlag.equals("0"))
                    item.setIcon(R.mipmap.btn_action_save);
                else if (actionList.get(i).getActionID().equalsIgnoreCase("Select"))     //筛选
                    item.setIcon(R.mipmap.btn_action_screening);
                else if (actionList.get(i).getActionID().equalsIgnoreCase("attention"))
                    item.setIcon(R.mipmap.btn_action_attention);
                else if (actionList.get(i).getActionID().equalsIgnoreCase("reject"))
                    item.setIcon(R.mipmap.btn_action_save);
                else if (actionList.get(i).getActionID().equalsIgnoreCase("Detail"))
                    item.setIcon(R.mipmap.btn_action_data);
                else
                    item.setIcon(R.mipmap.btn_action_submit);
            }
...
//            if (!actionList.get(i).getActionID().equalsIgnoreCase("reject")) { // 退回加在最后一个
            ...
            if (actionList.get(i).getAction_id().equalsIgnoreCase("submit")) // 提交
                ...
                item.setIcon(R.mipmap.btn_action_finish);
            } else if (actionList.get(i).getAction_id().equalsIgnoreCase("HZ90819d5afdc04d015afe2a3b4902bd")) {//特殊办结
                item.setIcon(R.mipmap.btn_action_special_finish);
            } else if (actionList.get(i).getAction_id().equalsIgnoreCase("HZ90819d5aea950c015af58eae89752c")) {//定稿
                item.setIcon(R.mipmap.btn_action_save);
