...
public class HorizontalSlideAdapter extends ArrayAdapter<PrevenanceResult> {
    ...
    public HorizontalSlideAdapter(Context context, List<PrevenanceResult> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(getContext(),
                    R.layout.listview_guanzhu_item, null);
            ...
            holder.infoTextView = (TextView) convertView
                    .findViewById(R.id.tv_guanzhu_title);
        ...
        Log.e("opo",getItem(position).DocTitle);
        holder.infoTextView.setText(getItem(position).DocTitle);
