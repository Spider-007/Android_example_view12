...
public class AddUserTask extends BaseTaskBody {

	private final String TAG = AddUserTask.class.getName();
	...
	protected HttpRequestEntity buildRequestEntity() {
		String nurl = ServerUrlConstant.SERVER_JAVA_URL() + ServerUrlConstant.SYNCDATA_ADD_USER_JAVA;
