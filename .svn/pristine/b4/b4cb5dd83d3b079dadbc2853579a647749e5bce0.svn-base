...
package com.htmitech.commonx.base.bitmap.core;
...
import com.htmitech.commonx.base.bitmap.factory.BitmapFactory;
import com.htmitech.commonx.base.cache.FileNameGenerator;
import com.htmitech.commonx.base.cache.LruDiskCache;
import com.htmitech.commonx.base.cache.LruMemoryCache;
...
public class BitmapCache {
        ...
        synchronized (mDiskCacheLock) {
            if (globalConfig.isDiskCacheEnabled() && (mDiskLruCache == null || mDiskLruCache.isClosed())) {
                ...
                if (diskCacheDir.exists() || diskCacheDir.mkdirs()) {
                    long availableSpace = DeviceUtils.getAvailableSpace(diskCacheDir);
    ...
    public Bitmap getBitmap(String uri){
        File bitmapFileFromDiskCache = getBitmapFileFromDiskCache(uri);
        if(bitmapFileFromDiskCache != null && !"".equals(bitmapFileFromDiskCache.getAbsolutePath())){
            return android.graphics.BitmapFactory.decodeFile(bitmapFileFromDiskCache.getAbsolutePath());
        }
        return null;
    }
