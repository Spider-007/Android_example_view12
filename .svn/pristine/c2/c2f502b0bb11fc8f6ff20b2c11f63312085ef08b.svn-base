 ...
 * 焊轨基地详情——钢厂
 */
public class WeldingBaseGCFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_welding_base_gc, container, false);
    }

    @Override
    protected void initView() {
        textViewTitle = (TextView) getView().findViewById(R.id.tv_welding_base_gc_title);
        fromLayout = (FromLayout) getView().findViewById(R.id.fromlayout_welding_base_gc);
    }
    ...
    protected void initData() {
        ...
        if ("DHG".equals(type)) {
            url = ContantValues.WELDINGBASEDETAILDHGGC;
            rawID = R.raw.hgjddhggc;
        } else if ("CPG".equals(type)) {
            url = ContantValues.WELDINGBASEDETAILCPGGC;
            rawID = R.raw.hgjdcpggc;
        }
...
//        request.userid =  ZTCustomInit.get().getmCache().getmListDetails().AccountId;
        ...
        Log.e("YJH", "getWeldingBaseDetailData->WeldingBaseGCFragment:"+ request.userid);
