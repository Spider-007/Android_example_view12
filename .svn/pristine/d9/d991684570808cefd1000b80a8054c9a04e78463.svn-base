...
import com.htmitech.adapter.GirdItemAdapter;
import com.htmitech.adapter.ImageFloderAdapter;
...
public class SelectPhotoActivity extends Activity {
    ...
    private static final int TAKE_CAMERA_PICTURE = 0x1000;//拍照
    ...
    private void setView() {
        ...
        quxiaoBtn = (ImageView) findViewById(R.id.btn_daiban_person);
    ...
    public void setDataView() {
        ...
        girdItemAdapter.setOnPhotoSelectedListener(new GirdItemAdapter.OnPhotoSelectedListener() {
            ...
            public void photoClick(List<String> number) {
                String bitMapUrl = number.get(0);
                Map<String, Object> map = new HashMap<String, Object>();
                map.put("imagePath", bitMapUrl);

                try {
                    ActivityUnit.switchTo(SelectPhotoActivity.this, TailoringActivity.class, map);
                } catch (Exception e) {
                    e.printStackTrace();
                }

//				Intent intent = new Intent(SelectPhotoActivity.this,TailoringActivity.class);
//				intent.putExtra("imagePath", bitMapUrl);
//				SelectPhotoActivity.this.startActivity(intent);
//				crop(Uri.fromFile(sdcardTempFile));
            }
        });
    }
