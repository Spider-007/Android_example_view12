package com.htmitech.emportal.ui.pop;
...
//            if (!actionList.get(i).getActionID().equalsIgnoreCase("reject")) { // 退回加在最后一个
            ...
            if (actionList != null && actionList.get(i) != null) {
                if (actionList.get(i).getActionID().equalsIgnoreCase("submit") && TodoFlag.equals("0")) // 提交
                    ...
                    item.setIcon(R.drawable.btn_action_screening);
                    ...
                    item.setIcon(R.drawable.btn_action_data);
                else
                    item.setIcon(R.drawable.btn_action_submit);
            }
