...
//                setBackgroundResource(R.drawable.edittext_select_back);
    ...
    public void mustInputLocal(boolean isMustInput, String value, int TabStyle){
        if (TabStyle == 0) {
            if(isMustInput && TextUtils.isEmpty(value)){
                setBackgroundResource(R.drawable.form_input_bg_must_local);
            }
        }
    }
