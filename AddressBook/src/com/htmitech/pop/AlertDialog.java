...
public class AlertDialog {
	...
	public static ArrayList<Dialog> dialogList = new ArrayList<Dialog>();
	...
	public AlertDialog builder() {
		...
		View view = LayoutInflater.from(context).inflate(
				R.layout.ht_view_alertdialog, null);
	...
	public AlertDialog isHD(){
		Animation shakeAnim = AnimationUtils.loadAnimation(context,
				R.anim.shake_x);
		txt_title.startAnimation(shakeAnim);
		return this;
	}
