...
//        this.setBackgroundColor(Color.BLACK);
        ...
        notScrollBarBg = new ColorDrawable(resources.getColor(R.color.colorAccent));
        hasScrollBarBg = new ColorDrawable(resources.getColor(R.color.colorAccent));
...
//        int height = measureHeight(heightMeasureSpec);
        ...
        mOffsetLow = formatDouble(defaultScreenLow / total * (mDistance)) + mThumbWidth / 2;
        mOffsetHigh = formatDouble(defaultScreenHigh / total * (mDistance)) + mThumbWidth / 2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        double progressLow = formatDouble((mOffsetLow - mThumbWidth / 2) * total / mDistance);
        double progressHigh = formatDouble((mOffsetHigh - mThumbWidth / 2) * total / mDistance);
...
//            }
    ...
    public void setProgressLow(double progressLow) {
        ...
        mOffsetLow = formatDouble(progressLow / total * (mDistance)) + mThumbWidth / 2;
        isEdit = true;
        refresh();
    }
    ...
    public void setProgressHigh(double progressHigh) {
        ...
        mOffsetHigh = formatDouble(progressHigh / total * (mDistance)) + mThumbWidth / 2;
        isEdit = true;
        refresh();
    }
...
/*    private int formatInt(double value) {
    ...
    //总进度
    public void setTotalScale(int total){
        this.total = total;
    }
    //表示单进度 还是双进度
    public void isTwoProgress(boolean isTwoProgress){
