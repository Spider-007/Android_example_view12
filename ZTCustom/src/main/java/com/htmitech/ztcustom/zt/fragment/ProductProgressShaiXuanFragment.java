...
public class ProductProgressShaiXuanFragment extends BaseFragment implements
	...
	private ProductProgressCallBackListener listener;
	private int width;
	// private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.productprogress_shaixuan_fragment,
				null, false);
	}
	...
	public void onClick(View arg0) {
		// TODO Auto-generated method stub
		if(arg0.getId() ==R.id.tv_productprogress_quding ){
			...
			listener.getData(list_wz, list_lx, rb_text);
		}else if(arg0.getId() ==R.id.tv_productprogress_clean){
			listener.cancle();
		}
	...
	public void onAttach(Activity activity) {
		...
		listener = (ProductProgressCallBackListener) activity;
	}
	...
	protected void initView() {
		...
		tv_cancle = (TextView) getActivity().findViewById(
				R.id.tv_productprogress_clean);
		tv_submit = (TextView) getActivity().findViewById(
				R.id.tv_productprogress_quding);
		rg_pmfs = (RadioGroup) getActivity().findViewById(
				R.id.rg_productprogress_shaixuan);

		rb_gg = (RadioButton) getActivity().findViewById(
				R.id.rb_productprogress_gg);
		rb_dc = (RadioButton) getActivity().findViewById(
				R.id.rb_productprogress_dc);
		rb_hf = (RadioButton) getActivity().findViewById(
				R.id.rb_productprogress_hf);

		ll_wz1 = (LinearLayout) getActivity().findViewById(
				R.id.ll_productporgress_wz1);
		ll_wz2 = (LinearLayout) getActivity().findViewById(
				R.id.ll_productporgress_wz2);
		ll_wz3 = (LinearLayout) getActivity().findViewById(
				R.id.ll_productporgress_wz3);
		ll_wz4 = (LinearLayout) getActivity().findViewById(
				R.id.ll_productporgress_wz4);
		ll_lx1 = (LinearLayout) getActivity().findViewById(R.id.ll_product_lx1);
		ll_lx2 = (LinearLayout) getActivity().findViewById(R.id.ll_product_lx2);
		ll_lx3 = (LinearLayout) getActivity().findViewById(R.id.ll_product_lx3);
		ll_lx4 = (LinearLayout) getActivity().findViewById(R.id.ll_product_lx4);
	...
	public void onCheckedChanged(RadioGroup arg0, int arg1) {
		// TODO Auto-generated method stub
		if(arg1 ==R.id.rb_productprogress_gg ){
			rb_gg.setButtonDrawable(R.drawable.zt_check_true);
			rb_dc.setButtonDrawable(R.drawable.zt_check_false);
			rb_hf.setButtonDrawable(R.drawable.zt_check_false);
			rb_text = "GG";
			getSBLXMX("GGZLX");
		}else if(arg1 ==R.id.rb_productprogress_dc){
			rb_gg.setButtonDrawable(R.drawable.zt_check_false);
			rb_dc.setButtonDrawable(R.drawable.zt_check_true);
			rb_hf.setButtonDrawable(R.drawable.zt_check_false);
			rb_text = "DC";
			getSBLXMX("CCGZ");
		}else if(arg1 ==R.id.rb_productprogress_hf){
			rb_gg.setButtonDrawable(R.drawable.zt_check_false);
			rb_dc.setButtonDrawable(R.drawable.zt_check_false);
			rb_hf.setButtonDrawable(R.drawable.zt_check_true);
			rb_text = "HF";
	...
	private void getWZShuJuZiDian(String dicttype) {
		// TODO Auto-generated method stub
		DicttypeResult dicttypeResult = ZTCustomInit.get().getmCache().getmDicttypeResult()
				.get("XB1");
		if (dicttypeResult.getDictitemlist() != null
			...
			for (int i = 0; i < dicList_wz.size(); i++) {
				...
				Log.e("GETNAME", dicList_wz.get(i).getName());
				...
				if (!flag_frist_act) {
					if (list_wz_act.contains(dicList_wz.get(i).getCode())) {
						button.setSelected(true);
					}
				}
				if (flag_frist_act) {
					...
					public void success(String successMessage) {
						...
						if (dicttypeResult.getDictitemlist() != null
							...
							for (int i = 0; i < diclist_lx.size(); i++) {
								final Button button = new Button(getActivity());
								Log.e("GETNAME___lx", diclist_lx.get(i)
										.getName());
