...
public class ZBWaterDropListViewFooter extends LinearLayout {
	...
	public ZBWaterDropListViewFooter(Context context) {
		super(context);
		initView(context);
	}
	
	public ZBWaterDropListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		mContext = context;
		LinearLayout moreView = (LinearLayout)LayoutInflater.from(mContext).inflate(R.layout.zb_waterdroplistview_footer, null);
		addView(moreView);
