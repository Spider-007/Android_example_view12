...
package com.htmitech.commonx.base.http;

import android.text.TextUtils;
import android.util.Log;

import com.alibaba.fastjson.JSON;
import com.htmitech.commonx.base.http.client.entity.BodyParamsEntity;
import com.htmitech.commonx.base.http.client.entity.JSONParamsEntity;
import com.htmitech.commonx.base.http.client.multipart.HttpMultipartMode;
import com.htmitech.commonx.base.http.client.multipart.MultipartEntity;
import com.htmitech.commonx.base.http.client.multipart.content.ContentBody;
import com.htmitech.commonx.base.http.client.multipart.content.FileBody;
import com.htmitech.commonx.base.http.client.multipart.content.InputStreamBody;
import com.htmitech.commonx.base.http.client.multipart.content.StringBody;
...
public class RequestParams {
	...
	private Object requestObject; //请求以对象发送
	...
	public HttpEntity getEntity() {
		...
		if (fileParams != null && !fileParams.isEmpty()) {
			...
			try {
				...
				result = new JSONParamsEntity(jsonParam.toString(), charset);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
			...
			try {
				...
				String storequest = JSON.toJSONString(requestObject);
				Log.d("RequestParams", storequest);
				result = new JSONParamsEntity(storequest, charset);
				
//				//测试代码
//				 Map<String, String> map = new HashMap<String, String>();
//				 map.put("causer", "true");
//				 map.put("message_id", "sxsw_login");
//				 map.put("pwd", "e10adc3949ba59abbe56e057f20f883e");
//				 map.put("userid", "chengxinzheng");
//				 map.put("stype", "0");
//				 map.put("PHONE_ID","A00000481936EC");
//				 
//				List<NameValuePair> nvpsList = mapToNameValuePairs(map);
//				
//				result = new UrlEncodedFormEntity(nvpsList, charset);
	...
	/* 把map的参数转化成NameValuePair数组对象
	 * 
	 * @param map
	 * @return
	 */
	public List<NameValuePair> mapToNameValuePairs(Map<String, String> map) {
		...
		if (map != null && map.size() > 0) {
			...
			while (iter.hasNext()) {
				String name = iter.next().trim();
					...
					nvps.add(new BasicNameValuePair(name.replaceAll(
							"_\\[\\d+\\]", ""), map.get(name)));
