...
import com.htmitech.commonx.base.http.callback.DefaultHttpRedirectHandler;
import com.htmitech.commonx.base.http.callback.FileDownloadHandler;
...
import com.htmitech.commonx.base.http.callback.StringDownloadHandler;
        ...
        if (statusCode < 300) {
            ...
            if (entity != null) {
                ...
                if (isDownloadingFile) {
                    autoResume = autoResume && NetworkUtil.isSupportRange(response);
                    String responseFileName = autoRename ? NetworkUtil.getFileNameFromHttpResponse(response) : null;
