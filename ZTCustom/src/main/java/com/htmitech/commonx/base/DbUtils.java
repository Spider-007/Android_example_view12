...
import com.htmitech.commonx.base.db.sqlite.CursorUtils;
import com.htmitech.commonx.base.db.sqlite.DbModelSelector;
import com.htmitech.commonx.base.db.sqlite.Selector;
import com.htmitech.commonx.base.db.sqlite.SqlInfo;
import com.htmitech.commonx.base.db.sqlite.SqlInfoBuilder;
import com.htmitech.commonx.base.db.sqlite.WhereBuilder;
import com.htmitech.commonx.base.db.table.DbModel;
import com.htmitech.commonx.base.db.table.Id;
import com.htmitech.commonx.base.db.table.Table;
import com.htmitech.commonx.base.db.table.TableUtils;
import com.htmitech.commonx.base.exception.DbException;
import com.htmitech.commonx.util.IOUtils;
...
public class DbUtils {
    ...
    /**
     * 打开数据库，如果数据库不存在，则创建数据库，默认数据库名称为：commX.db
     * 
     ...
     * @param dbUpgradeListener     版本升级接口
     * 
     * @return  返回已生成的数据库对象
     */
    ...
    /**
     * 设置是否允许当前数据库对象进行批量事务处理
     * 
     * @param allowTransaction  允许true，不允许false
     * 
     * @return  返回设置完成的数据库对象
     */
    ...
    /**
     * 保存单个数据，如果数据已经存在，则更新该数据，默认表名为数据对象的class名
     * 
     * @param entity    数据对象
     * 
     * @throws DbException
    ...
    /**
     * 批量保存数据，单个数据如果存在，则更新该数据，默认表名为数据对象的class名
     * 
     * @param entities  数据列表
     * 
     * @throws DbException
    ...
    /**
     * 批量保存对象，并为对象的Id属性与数据库生成的主键Id关联
     * 
     * @param entities  对象List
     * 
     * @throws DbException
     */
     ...
     * 删除一个数据
     * 
     * @param entityType   数据Class对象，可理解为表名
     * @param idValue   待删除数据
     * 
     * @throws DbException
     */
     ...
     * 删除一个数据
     * 
     * @param entity    数据对象，默认表结构和表名为数据对象的class名
     * 
     * @throws DbException
     */
    ...
    /**
     * 删除表
     * @param entityType    数据结构class对象，即表名
     * 
     * @throws DbException
     */
     ...
     * 
     * @param entity    待更新数据
     * @param updateColumnNames 更新字段，不指定则为全部字段更新
     * 
     * @throws DbException
     */
    ...
    public static class DaoConfig {
        ...
        private String dbName = "commX.db"; // default db name
