...
public class SystemNewsActivity extends RootActivity {
	...
	private TextView start_btn1 = null;
	private TextView start_btn2 = null;
	private TextView start_btn3 = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		start_btn1 = (TextView) view1.findViewById(R.id.start_btn1);
		start_btn2 = (TextView) view2.findViewById(R.id.start_btn2);
		start_btn3 = (TextView) view3.findViewById(R.id.start_btn3);
		...
		start_btn2.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				startMainView();
			}
		});
		start_btn3.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				startMainView();
			}
