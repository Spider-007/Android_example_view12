...
import com.htmitech.video.bean.IVideoInfo;
import com.htmitech.video.listener.OnVideoControlListener;
import com.htmitech.video.listener.SimplePlayerCallback;
import com.htmitech.video.utils.NetworkUtils;
import com.htmitech.video.view.VideoBehaviorView;
import com.htmitech.video.view.VideoControllerView;
import com.htmitech.video.view.VideoProgressOverlay;
import com.htmitech.video.view.VideoSystemOverlay;
...
public class BDVideoView extends VideoBehaviorView {
    ...
    private void init() {
        ...
        mSurfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                initWidth = FrameLayout.LayoutParams.MATCH_PARENT;
                initHeight = FrameLayout.LayoutParams.MATCH_PARENT;
    ...
    public void onResumeStart(String type) {
//        mMediaPlayer.seekTo(currentTime);
//        onStart();
        mediaController.setPauseClick(type);
    }
...
//        videoPath = mJITSecurityManager.createNewUrl(videoPath);
