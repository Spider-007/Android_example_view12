package com.htmitech.video.view;
...
import com.htmitech.video.BDVideoPlayer;
...
import com.htmitech.video.utils.StringUtils;
...
public class VideoControllerView extends FrameLayout {
    ...
    public void setPauseClick(String type) {
        if ("play".equals(type) && !mPlayer.isPlaying()) {
            play();
        } else if ("pause".equals(type) && mPlayer.isPlaying()) {
            pause();
        }
//            mVideoPlayState.performClick();
    }
