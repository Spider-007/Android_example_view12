...
public class CalendarManager {
    ...
    public boolean calendarState = false;
    ...
    public String getDateAndWeek() {
        String result = "获取时间失败";
        try {
            LocalDate mDateAndWeek = mSelected;
            if (mDateAndWeek == null) {
                mDateAndWeek = LocalDate.now();
            }
             result =mDateAndWeek.toString();
            int dayOfWeek = mDateAndWeek.getDayOfWeek();
            switch (dayOfWeek) {
                case 1:
                    result+=" 星期一";
                    break;
    ...
    public Date getCurrentMonth(){
        return ScheduleUtils.transferDateTime(monthStr);
    }
