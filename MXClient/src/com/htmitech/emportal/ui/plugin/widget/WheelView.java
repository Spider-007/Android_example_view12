...
package com.htmitech.emportal.ui.plugin.widget;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(DensityUtil.dip2px(getContext(),TEXT_SIZE));
		}
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(DensityUtil.dip2px(getContext(),TEXT_SIZE));
