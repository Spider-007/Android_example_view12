...
public class RadioPeople601_02_03 {
    ...
    public LinearLayout peopleChckLayout(String VlineVisible, FieldItem item, LayoutInflater mInflater, TextView currentEditTextViewd, CallBackDoAction mCallBackDoActions) {
        // 5,
        // ***********************人员多选选择：id1;id2;id3**************************
        ...
        tvEditValue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                BookInit.getInstance().setCallCheckUserListener(context, ChooseWayEnum.PEOPLECHOOSE, ChooseWay.SINGLE_CHOOSE, ChooseTreeHierarchy
    ...
    public LinearLayout peopleChckLayoutCommonForm(boolean VlineVisible, Fielditems item, LayoutInflater mInflater, TextView currentEditTextViewd, CallBackDoAction mCallBackDoActions) {
        // 5,
        // ***********************人员多选选择：id1;id2;id3**************************
        currentEditTextView = currentEditTextViewd;
        this.mCallBackDoAction = mCallBackDoActions;
