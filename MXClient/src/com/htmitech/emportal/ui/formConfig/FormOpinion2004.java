...
//    }
//    //可编辑字段 输入方式为11
//    public LinearLayout Opinion2004(String VlineVisible,FieldItem item,LayoutInflater mInflater,List<TextView> list_tvsize,FormFragment.CellOnclickLisener2004 mCellOnclickLisener,int com_workflow_mobileconfig_IM_enabled){
//        {
//            // 1，**********************处理可编辑的意见字段******************************
...
//                        text.setBackgroundColor(context.getResources().getColor(R.color.form_bg_must));
//                    }else {
//                        text.setBackgroundResource(R.drawable.text_back);
//                    }
//
//
...
//                    }
//
//                    String name1 =  PreferenceUtils                                    //单击布局拿到当前用户
...
//                    text.setOnClickListener(mCellOnclickLisener);
...
//
//    //可编辑字段 输入方式为11
//    public LinearLayout Opinion2004CommonForm(boolean VlineVisible, Fielditems item, LayoutInflater mInflater, List<TextView> list_tvsize, GeneralFormDetailFragment.CellOnclickLisener2004 mCellOnclickLisener, int com_workflow_mobileconfig_IM_enabled){
//        {
//            // 1，**********************处理可编辑的意见字段******************************
//            LinearLayout lineView = new LinearLayout(                            //设置一个容器和背景及显示方式
//                    HtmitechApplication.instance());
