...
import com.htmitech.emportal.ui.daiban.model.task.GetGuanZhuTask;

/**
 * Created by yanxin on 2016-9-28.
 */
public class GetGuanZhuModel extends BaseModel{
    private GetGuanZhuTask mTask;
    ...
    public GetGuanZhuModel(IBaseCallback callback) {
        super(callback);
    }
