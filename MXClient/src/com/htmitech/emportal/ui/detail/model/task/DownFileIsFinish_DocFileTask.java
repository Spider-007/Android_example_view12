...
public class DownFileIsFinish_DocFileTask extends BaseTaskBody {
	private final String TAG = DownFileIsFinish_DocFileTask.class.getName();
	...
	public DownFileIsFinish_DocFileTask(int taskType) {
	...
	protected HttpRequestEntity buildRequestEntity() {
		HttpRequestEntity requestEntity = new HttpRequestEntity(
				...
				ServerUrlConstant.OA_DOWNFILE_ISFinish_DOCFile_METHOD);
		if (paramObject != null) {
