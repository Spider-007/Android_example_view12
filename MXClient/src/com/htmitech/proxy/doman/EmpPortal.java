...
public class EmpPortal {
    ...
    public int title_display_style;

    public int getTitle_display_style() {
        return title_display_style;
    }

    public void setTitle_display_style(int title_display_style) {
        this.title_display_style = title_display_style;
    }
